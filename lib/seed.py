...
#     # Sample Reviews
#     Review(username="alice_j", comment="Amazing pizza and great ambiance!", restaurant_id=pizza_inn.id, customer_id=alice.id).save()
#     Review(username="keith_s", comment="Breathtaking views and delicious food!", restaurant_id=mountain_delight.id, customer_id=keith.id).save()
#     Review(username="lio_m", comment="Great vibe, but food was average.", restaurant_id=urban_eats.id, customer_id=lio.id).save()
